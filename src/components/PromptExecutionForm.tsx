      ...
      case 'boolean':
        return (
          <div className="flex items-center">
            ...
            />
            <label htmlFor={variable.name} className="ml-2 text-sm text-gray-700">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 p-4 rounded-lg border max-h-48 overflow-y-auto">
        <h3 className="text-sm font-medium text-gray-900 mb-2">Prompt Template:</h3>
      ...
      {prompt.variables && prompt.variables.length > 0 ? (
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">Fill in the variables:</h3>
